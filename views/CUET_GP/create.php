...
<div>
    <h1 style="text-align: center">Profile Create Form</h1>
</div>
<div class="row">
...
<form action="store.php" method="post">
    ...
    Contact No:
    <input class="form-control" type="number" name="contact"><br>
    Address:
    <select name="address" class="form-control">
            <option value="Chittagong">Chittagong</option>
            <option value="Dhaka">Dhaka</option>
    </select><br>
    <input type="checkbox" id="radio" name="donar" value="No" required> Active Account<br><br>
