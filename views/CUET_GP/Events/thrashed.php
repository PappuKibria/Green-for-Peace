...
<div class="row">
    ...
    <div class="col-xs-2">
        <a href='event_admin.php' class='btn btn-warning'>Active List</a>
        <a href='events_create.php' class='btn btn-primary'>Add Event</a>
    </div>
    <div class="col-xs-5"></div>
</div>
        ...
        foreach($allData as $oneData){
            ...
            echo "
                  ...
                  <tr  style='background-color: $bgColor'>
                     ...
                     <td>$oneData->event_date_start</td>
                     <td>$oneData->event_date_end</td>
                     <td>$oneData->event_location</td>

                     <td>
                     <a href='view.php?event_id=$oneData->event_id' class='btn btn-info'>VIEW</a> 
                     
                     <a href='recover.php?event_id=$oneData->event_id' class='btn btn-warning'>ACCEPT</a>
                     
                     <a href='edit.php?event_id=$oneData->event_id' class='btn btn-info'>EDIT</a> 
                     </td>
                  </tr>
              ";
            $serial++;
