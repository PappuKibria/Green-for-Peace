...
<div class="col-xs-12 col-md-12">
    ...
    <div class="col-xs-4 col-md-4">
        ...
        <a href='events_create.php?id=$oneData->id' class='btn btn-info' style="height: 35px; width: 200px;">Create Profile</a>
    </div>
...
<div class="container">
    <h1 style="text-align: center">Event - Active List</h1>
    ...
    <table class="table table-striped table-bordered" cellspacing="0px">
        ...
        <tr>
            ...
            <th style='width: 10%; text-align: center'>Event Title</th>
            <th style='width: 10%; text-align: center'>Event Starting Date</th>
            <th style='width: 10%; text-align: center'>Event Ending Date</th>
            <th style='width: 10%; text-align: center'>Event Location</th>
        ...
        foreach($someData as $oneData){
            ...
            echo "
                 <tr style='background-color: $bgColor'>
                     ...
                     <td style='width: 10%; text-align: center'>$oneData->event_title</td>
                     <td style='width: 10%; text-align: center'>$oneData->event_date_start</td>
                     <td style='width: 10%; text-align: center'>$oneData->event_date_end</td>
                     <td style='width: 10%; text-align: center'>$oneData->event_location</td>
                   <!--  <td>$oneData->event_description</td> -->
                     
                 
                     <td style='width: 25%; text-align: center'>
                     <a href='view.php?event_id=$oneData->event_id' class='btn btn-info' style='height: 35px; width: 100px;'>VIEW Details</a> 
                     <a href='edit.php?event_id=$oneData->event_id' class='btn btn-primary'>EDIT</a> 
                     <a href='trash.php?event_id=$oneData->event_id' class='btn btn-warning'>SOFT DELETE</a> 
                     <a href='delete.php?event_id=$oneData->event_id' class='btn btn-danger'>DELETE</a>
                     </td>
