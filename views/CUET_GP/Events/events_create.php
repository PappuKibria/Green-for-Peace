...
<div>
    <h1 style="text-align: center">Event Create Form</h1>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-6">
        <form action="store.php" method="post" enctype="multipart/form-data">
            ...
            Event Title:
            <input class="form-control" type="text" name="event_title"><br>
            Event Host:
            <input class="form-control" type="text" name="event_host"><br>
            Event Start Time:
            <input class="form-control" type="datetime-local" name="event_date_start"><br>
            Event End Time:
            <input class="form-control" type="datetime-local" name="event_date_end"><br>
            Event Location:
            <input class="form-control" type="text" name="event_location"><br>
            Event Photo (Photo size must not be above 500kb):
            <input class="form-control" type="file" name="event_photo"><br>
            Event Description:
            <textarea rows="10" class="form-control" name="event_description"></textarea><br>
            <input type="checkbox" name="publication_status" value="0" required> Confirm to Publish Event<br><br>
            <input type="submit" class="btn btn-warning" value="Create Event">
        </form>
    </div>
    <div class="col-xs-3 col-md-3"></div>
</div>
