...
<div class="row">
    ...
    <div class="col-xs-6 col-md-6">
        ...
        <form action="login.php" method="post">
            ...
            <input class="form-control" type="hidden" name="admin_id"><br>
            Email:
            <input class="form-control" type="email" name="admin_email" required><br>
            Password:
            <input class="form-control" type="password" name="admin_password" required><br>
