...
<div class="row">
    ...
    <div class="col-xs-2">
        <a href='member_admin.php' class='btn btn-warning'>Active List</a>
        <a href='member_create.php' class='btn btn-primary'>Add Blog</a>
    </div>
    <div class="col-xs-5"></div>
</div>

<div class="container">
    <h1 style="text-align: center">Member - Trashed List</h1>
        ...
        foreach($allData as $oneData){
            ...
            echo "
                  ...
                  <tr  style='background-color: $bgColor'>
                     ...
                     <td style='width: 10%; text-align: center'>$oneData->student_id</td>
                     <td>$oneData->member_name</td>
                     <td>$oneData->member_address</td>
                     <td>$oneData->member_contact</td>
                     <td>$oneData->member_photo</td>

                     <td>
                     <a href='view.php?member_id=$oneData->member_id' class='btn btn-info'>VIEW</a> 
                     
                     <a href='recover.php?member_id=$oneData->member_id' class='btn btn-warning'>ACCEPT</a>
                     
                     <a href='edit.php?member_id=$oneData->member_id' class='btn btn-info'>EDIT</a> 
                     </td>
                  </tr>
              ";
            $serial++;
