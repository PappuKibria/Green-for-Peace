        ...
        foreach($someData as $oneData){
            ...
            echo "
                 <tr style='background-color: $bgColor'>
                     ...
                     <td style='width: 50%; text-align: center'>$oneData->member_name</td>
                     <td style='width: 50%; text-align: center'>$oneData->member_address</td>
                     <td>$oneData->member_contact</td>
                     <td style='width: 50%; text-align: center'><img src='Upload/$oneData->member_photo' alt=\"Profile Photo\" style=\"50px; height: 50px;\"><br><br></td>
                     
                     
                 
                     <td>
                     <a href='view.php?member_id=$oneData->member_id' class='btn btn-info' style='height: 40px; width: 200px;'>VIEW Details</a> 
