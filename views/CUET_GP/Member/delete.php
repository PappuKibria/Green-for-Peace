...
<div class="container">
    ...
    <a href='delete.php?member_id=<?php echo $oneData->member_id?>&Yes=1' class="btn btn-group-lg btn-danger">Yes</a>
    <a href='member_admin.php' class="btn btn-group-lg btn-info">No</a><br><br><br>
