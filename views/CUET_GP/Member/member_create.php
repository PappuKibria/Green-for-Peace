...
<div>
    <h1 style="text-align: center">Member Registration Form</h1>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-6">
        <form action="store.php" method="post" enctype="multipart/form-data">
            ...
            Student ID:
            <input class="form-control" type="text" name="student_id"><br>
            Name:
            <input class="form-control" type="text" name="member_name"><br>
            Address:
            <input type="text" class="form-control" name="member_address"><br>
            Contact No:
            <input type="text" class="form-control" name="member_contact"><br>

            Profile Photo (Photo size must not be above 500kb):
            <input class="form-control" type="file" name="member_photo"><br>

            <input type="checkbox" name="publication_status" value="0"> Confirm to Join<br><br>
