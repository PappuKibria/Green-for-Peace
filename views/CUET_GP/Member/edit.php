            ...
            <div class="col-md-12">
                <div class="block">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">GP Member List - Edit</li>
                    </ol>
                </div>
...
<div class="container">
    ...
    <div class="navbar">
        ...
        <td><a href='member.php' class='btn btn-group-lg btn-info'>Active-List</a> </td>
    ...
    <form  class="form-group f" action="update.php" method="post">
        ...
        Student ID:
        <input class="form-control" type="text" name="student_id" value="<?php echo $oneData->student_id?>">
        <br>
        Name:
        <input class="form-control" type="text" name="member_name" value="<?php echo $oneData->member_name?>">
        <br>
        Address:
        <input class="form-control" type="text" name="member_address" value="<?php echo $oneData->member_address?>">
        <br>
        Contact:
        <input class="form-control" type="text" name="member_contact" value="<?php echo $oneData->member_contact?>">
        <br>

        Profile Photo (Photo size must not be above 500kb):
        <input class="form-control" type="file" name="member_photo" value="<?php echo $oneData->member_photo?>"><br>

        <input type="checkbox" name="publication_status" value="1"> Confirm to Join<br><br>

        <input type="hidden" name="member_id" value="<?php echo $oneData->member_id ?>">
