...
<div class="container">
    ...
    <a href='delete.php?blog_id=<?php echo $oneData->blog_id?>&Yes=1' class="btn btn-group-lg btn-danger">Yes</a>
    <a href='blog_admin.php' class="btn btn-group-lg btn-info">No</a><br><br><br>
