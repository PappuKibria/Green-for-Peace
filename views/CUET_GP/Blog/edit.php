...
<div class="container">
    ...
    <div class="navbar">
        ...
        <td><a href='blog.php' class='btn btn-group-lg btn-info'>Active-List</a> </td>
    ...
    <form class="form-group f" action="update.php" method="post">
        ...
        Blog Title:
        <input class="form-control" type="text" name="blog_title" value="<?php echo $oneData->blog_title?>"><br>
        Author Name:
        <input class="form-control" type="text" name="author_name" value="<?php echo $oneData->author_name?>"><br>
        Blog Description:
        <textarea rows="10" class="form-control" name="blog_description"><?php echo $oneData->blog_description?></textarea><br>

        <input type="checkbox" name="publication_status" value="1"> Confirm to Active Blog<br><br>

        <input type="hidden" name="blog_id" value="<?php echo $oneData->blog_id ?>">

        <input type="submit" class="btn btn-warning" value="Save Blog">
    </form>
