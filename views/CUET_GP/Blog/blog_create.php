...
<div>
    <h1 style="text-align: center">BLOG Create Form</h1>
</div>
<div class="row">
    ...
    <div class="col-xs-6 col-md-6">
        <form action="store.php" method="post">
            ...
            Blog Title:
            <input class="form-control" type="text" name="blog_title"><br>
            Author Name:
            <input class="form-control" type="text" name="author_name"><br>
            Blog Description:
            <textarea rows="10" class="form-control" name="blog_description"></textarea><br>
            <input type="checkbox" name="publication_status" value="0" required> Confirm<br><br>
