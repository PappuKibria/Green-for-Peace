...
<div class="container">
        <h1 style="text-align: center">BLOG - Details Information</h1>
    <br>

    <div style="text-align: justify; background-color: darkgreen;">
        <h1 style="text-align: center; color: white; margin-top: 30px;"><b><br><br><?php echo $oneData->blog_title; ?></b></h1>
        <h3 style="text-align: center; color: white; margin-top: 30px; margin-left: 100px;"><b><?php echo $oneData->author_name."<br>"; ?></b></h3>
        <p style="margin: 30px; color: white; font-size: large; font-kerning: auto; "><?php echo $oneData->blog_description."<br>"; ?></p><br>
    </div>

    <!-- Facebook -->
<div style="align-items: center">
    <a href="http://www.facebook.com/sharer.php?u=https:javascript:window.location.reload(true)" target="_blank">
