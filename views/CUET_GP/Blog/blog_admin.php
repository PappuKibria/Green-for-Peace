...
if(isset($_REQUEST['search']))$someData =  $objBlog->search($_REQUEST);


$availableKeywords=$objBlog->getAllKeywords();
...
if(isset($_REQUEST['search']) ) {
    $someData = $objBlog->search($_REQUEST);
    $serial = 1;
}
...
<div class="col-xs-12 col-md-12">
    ...
    <div class="col-xs-4 col-md-4">
        ...
        <a href='blog_create.php?id=$oneData->id' class='btn btn-info' style="height: 35px; width: 200px;">Create Profile</a>
    </div>
...
<div class="container">
        ...
        foreach($someData as $oneData){
            ...
            echo "
                 <tr style='background-color: $bgColor'>
                     ...
                     <!--<td style='width: 10%; text-align: center'>$oneData->blog_id</td>-->
                     <td style='width: 20%; text-align: center'>$oneData->blog_title</td>
                     <td style='width: 20%; text-align: center'>$oneData->author_name</td>
                   <!--  <td>$oneData->blog_description</td> -->
                     
                 
                     <td>
                     <a href='view.php?blog_id=$oneData->blog_id' class='btn btn-info' style='height: 35px; width: 100px;'>VIEW Details</a> 
                     <a href='edit.php?blog_id=$oneData->blog_id' class='btn btn-success' style='height: 35px; width: 100px;'>EDIT</a> 
                     <a href='delete.php?blog_id=$oneData->blog_id' class='btn btn-danger' style='height: 35px; width: 100px;'>DELETE</a>
                     <a href='trash.php?blog_id=$oneData->blog_id' class='btn btn-warning'>SOFT DELETE</a> 
                     </td>
    ...
    <div align="left" class="container">
        ...
        <ul class="pagination">
            ...
            if($page>$pages) Utility::redirect("blood.php?Page=$pages");
